...
namespace ALSL_HRM_System.Forms
{
    public partial class frmServiceExtendRequest : Office2007Form
    {
        ...
        public frmServiceExtendRequest(frmMDIMain form)
        {
            this.form = form;
            InitializeComponent();
            DBConnectionMethod();
        ...
        private void AddNew()
        {
            ...
            ClearAllFields(this);
            String newSerReqId = Regex.Replace(GetNextID(), "\\d+",
        ...
        private void cmbEmployeeID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@Employee_No", (cmbEmployeeID.Text).ToString());
            cmd.CommandType = CommandType.StoredProcedure;
            rs = cmd.ExecuteReader();
        ...
        private void SaveData()
        {
            try
            {
                ...
                {
                    cmd.CommandText = "Update_ServiceExtendRequestData";
                }
                ...
                if (checkSave == 1)
                {
                    MessageBox.Show("Service Extend Request Details Added.", Properties.Resources.CompanyName, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    
                    checkSave = 0;
                }
                else
                {
                    MessageBox.Show("Service Extend Request Details Updated.", Properties.Resources.CompanyName, MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        {
            String OldServiceExtReqId = null;
            SqlCommand command = new SqlCommand("sp_SelectAll_ServiceExtendRequestData", obj.sqlConnection);
            command.CommandType = System.Data.CommandType.StoredProcedure;

            rs = command.ExecuteReader();

            while (rs.Read())
                OldServiceExtReqId = rs[0].ToString();
            rs.Close();
            return OldServiceExtReqId;
        }
        ...
        private void dgvServiceExtendRequest_SelectionChanged(object sender, EventArgs e)
        {
            ...
            if (dgvServiceExtendRequest.SelectedRows.Count == 1)
            {
                ...
                txtFullName.Text = dgvServiceExtendRequest.SelectedRows[0].Cells[2].Value.ToString();
                txtReqMonths.Text = dgvServiceExtendRequest.SelectedRows[0].Cells[3].Value.ToString();
        ...
        private void ClearAllFields(Control con)
        {
            ...
            dgvServiceExtendRequest.DataSource = null;
            btnDelete.Enabled = false;
        }
        ...
        {
            dlgSearch dlgBox = new dlgSearch("Search Service Extend Request Details", "Extend_Req_ID", "Employee_ID", "Unused", "sp_Search_ServiceExtendRequestData");
        ...
        private Boolean ValidateMethod()
        {
            ...
            bool x1 = String.IsNullOrEmpty(txtServiceExtReqID.Text.ToString());
            bool x2 = String.IsNullOrEmpty(txtReqMonths.Text.ToString());
            bool x3 = String.IsNullOrEmpty(cmbEmployeeID.Text.ToString());
