...
namespace ALSL_HRM_System.Forms
{
    public partial class frmLeaveTypeDetails : Office2007Form
    {
        ...
        private void AddNew()
        {
            ...
            ClearAllFields(this);
            String newLeaveTypeNo = Regex.Replace(PopulateData(2), "\\d+",
        ...
        private void SaveData()
        {
            try
            {
                ...
                {
                    cmd.CommandText = "sp_Update_LeaveTypeData";
                }
                ...
                if (checkSave == 1)
                {
                    MessageBox.Show("Leave Type Details Added...");
                    checkSave = 0;
                }
                else
                {
                    MessageBox.Show("Leave Type Details Updated...");
                }
        ...
        private void DeleteData()
        {
            ...
            try
            {
                ...
                cmd.ExecuteNonQuery();
                MessageBox.Show("Leave Type Details Deleted...");
            }
        ...
        {
        //    DialogBox1 form2 = new DialogBox1("Search Leave Type Details", "Leave_Type_No", "Leave_Type_Desc");
